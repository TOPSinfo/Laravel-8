...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{__('admin.label.add')}} {{__('admin.label.cms')}}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{__('admin.label.dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('admin.label.add')}} {{__('admin.label.cms')}} </li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <form enctype="multipart/form-data" id="cms-add" action="{{route('cms.store')}}"  method="POST">
            @csrf
            @method('POST')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="ckeditor form-control" name="description" id="description" placeholder="Enter Description"></textarea>
