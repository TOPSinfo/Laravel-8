    ...
    <div class="row mt-2">
        <div class="col-8">
            <div class="page-title-box">
                <h4 class="page-title">{{__('admin.label.module')}} {{__('admin.label.management')}}</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">{{__('admin.label.dashboard')}}</a></li>
                        <li class="breadcrumb-item active">{{__('admin.label.module')}} {{__('admin.label.management')}}</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="col-4">
            @can('create-module')
            <a href="{{route('module.create')}}" class="btn btn-success btn-add-new float-right">
                <i class="voyager-plus"></i> <span>{{__('admin.label.add')}} {{__('admin.label.module')}}</span>
            </a>
            @endcan
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box mb-0">
                ...
                <table id="listing-module" class="custom-table dataTable data-table-btn" style="width:100%">
                    <thead>
                    <tr>
                        <th>#Id</th>
