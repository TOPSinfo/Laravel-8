...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-2">
            <div class="col-8">
                <div class="page-title-box">
                    <h4 class="page-title">{{__('admin.label.user')}} {{__('admin.label.management')}}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{__('admin.label.dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('admin.label.user')}} {{__('admin.label.management')}}</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="col-4">
                @can('create-user')
                <a href="{{route('user.create')}}" class="btn btn-success btn-add-new float-right">
                    <i class="voyager-plus"></i> <span>{{__('admin.label.add')}} {{__('admin.label.user')}}</span>
                </a>
                @endcan
                @can('bulkdelete-user')
        ...
        @include('alerts.multideletemodel',['redirectTo' => 'delete-multiple-user'])
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="table-responsive inbound-table">
                        <table id="dataTable" class="custom-table dataTable data-table-btn" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>{{__('admin.label.role')}}</th>
                                <th>{{__('admin.label.gender')}}</th>
